...
/**
 * Client Messages UI Component
 * Displays the chat interface from the client's perspective
 */
export default function ClientMessagesUI({
  trainer,
  clientName,
  messages,
  newMessage,
  ...
  // Get initials for trainer avatar
      ...
      >
        <div className="d-flex align-items-center">
          ...
          <div className="flex-grow-1">
            <h6 className="text-white mb-0 fw-bold">{trainerName}</h6>
